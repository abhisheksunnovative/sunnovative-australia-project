...
const leadSchema = new mongoose.Schema(
  {
    ...
    isInstallDateOtpVerified: { type: Boolean, default: false },
    assignedEPCId: { type: String },
    assignedEpc: { type: mongoose.Schema.Types.ObjectId, ref: 'EpcPartner', default: null },
    assignedEPCName: { type: String },
    epcDetails: { type: Object },
    enquiryStatus: { type: String },
    bdeMovedToOrderJourney: { type: Boolean, default: false },

...
export const WebAppAnalyticsScreen = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Web App & Website Analytics</h2>
          <p className="text-sm text-slate-500">Track usage geographically across devices and platforms.</p>
        </div>
      </div>
...
export default WebAppAnalyticsScreen;
'''

with open('Website_Admin/src/components/WebAppAnalyticsScreen.jsx', 'w', encoding='utf-8') as f:
    f.write(new_code)

print("WebAppAnalyticsScreen Created")

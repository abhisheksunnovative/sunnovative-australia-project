...
const endIndex = c.indexOf('{/* COMMISSION PER LEAD (FREELANCERS ONLY) */}');
        ...
        <div className="bg-gradient-to-br from-amber-500 via-yellow-500 to-amber-600 rounded-2xl p-6 text-slate-950 shadow-md flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-slate-900">Total Accrued: \${(stats.freelancerSettings?.totalEarnings || 1250).toLocaleString()}</p>
            </div>
          </div>
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  console.log("Updated BDEAustDashboard.jsx!");
} else {

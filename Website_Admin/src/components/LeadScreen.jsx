                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1.5">
                        ...
                        {lead.convertedProjectId ? (
                          ...
                          <button 
                            disabled className="px-2.5 py-1 bg-slate-100 text-slate-500 font-semibold text-[10px] rounded-lg border border-slate-200 flex items-center gap-1 shadow-xs cursor-default"><Clock className="w-3 h-3 text-cyan-600"/> New Lead</button>
                        ) : (

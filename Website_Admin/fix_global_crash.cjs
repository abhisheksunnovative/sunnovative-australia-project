...
const trueLeadsLogic = `  const trueLeads = leads.filter(l => {
...
c = c.replace(trueLeadsLogic, '  // removed trueLeads for BDEDashboard since leads are not fetched here directly');
